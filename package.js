{
  "name": "BOOM-MD",
  "version": "1.0.0",
  "description": "A WhatsApp Bot Created By NETHUWH",
  "main": "index.js",
  "scripts": {
    "start": "pm2 start index.js --deep-monitoring --attach --name KHAN-MD",
    "stop": "pm2 stop ʙᴏᴏᴍ-ᴍᴅ",
    "restart": "pm2 restart boom-md"
  },
  "dependencies": {
